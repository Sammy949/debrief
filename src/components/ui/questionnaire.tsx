...
function QuestionnaireTitle({
  ...
  return (
    <QuestionnairePrimitive.Title
      ...
      className={cn(
        "font-serif text-base leading-snug font-medium text-pretty [&:not(:has(~[data-slot=questionnaire-description]))]:mb-4",
        className
      )}
      {...props}
    />
  ...
  return (
    ...
    >
      ...
      <span
        ...
        className="pointer-events-none relative flex size-4 shrink-0 translate-y-[--spacing(0.45)] items-center justify-center border border-input group-has-data-[slot=questionnaire-choice-description]/questionnaire-choice:translate-y-0.5 group-data-checked/questionnaire-choice:border-amber group-data-checked/questionnaire-choice:bg-amber group-data-checked/questionnaire-choice:text-obsidian"
      >
        <span
          data-slot="questionnaire-choice-indicator-dot"
          className="hidden size-2 bg-obsidian group-data-[type=checkbox]/questionnaire-choice:hidden group-data-checked/questionnaire-choice:block"
        />
        <Check
          weight="bold"
